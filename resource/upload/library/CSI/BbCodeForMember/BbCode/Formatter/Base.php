<?php namespace CSI\BbCodeForMember\BbCode\Formatter;

/**
 * Class Base
 * @package CSI\BbCodeForMember\BbCode\Formatter
 */
class Base
{
  /**
   ...
   * @return mixed
   */
  public static function getBbCodeForMember(array $tag, array $rendererStates, \XenForo_BbCode_Formatter_Base $formatter)
  {
    ...
    if ($view) {
      $template = $view->createTemplateObject('csiXF_bbCode_CECD5F95_tag_for_member',
        array(
          'content' => $tagContent,
          'option' => $optDefault,
        ));
